      ...
      <div class="form">
        <form name="frm" action="" method="post" enctype="multipart/form-data">
              ...
              <div class="form-group">
                <label for="subjectid" class="form-label">SUBJECT</label>
                  ...
                  <?php
                   ...
                   {
                      echo("<br><input type='text' value=".$row["subid"].">".$row["subname"]."&ensp;");
                      echo("<input type='text' name='txtobtainmarks[]'>");
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control" id="totalmarks" value="100" name="txttotalmarks">
              </div>
              ...
              <div class="form-group dropdown"> 
                ...
                <input type="text" class="form-control" id="passingmarks" value="35" name="txtpassingmarks">
               </div>
